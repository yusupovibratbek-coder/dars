...
export default function Home() {
  return (
    <div className="bg-white min-h-screen">
      <div className="flex justify-around p-10 bg-green-600 border-white border-3 rounded-4xl ">
      ...
      <div className="flex justify-around p-10 bg-black border-white border-3 rounded-4xl ">
